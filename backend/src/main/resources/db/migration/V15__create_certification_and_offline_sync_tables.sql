...
CREATE TABLE IF NOT EXISTS certifications (
    ...
    CONSTRAINT fk_certification_org FOREIGN KEY (organization_id) REFERENCES organizations(organization_id),
    CONSTRAINT fk_certification_standard FOREIGN KEY (standard_id) REFERENCES standards(id)
);

CREATE INDEX idx_certification_org ON certifications(organization_id);
CREATE INDEX idx_certification_standard ON certifications(standard_id);
