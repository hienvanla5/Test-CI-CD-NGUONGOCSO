...
public class CustomUserDetailsService implements UserDetailsService {
         ...
         *
         * <p>
         * The returned {@link UserDetails} contains both the user's
         * identity and the role assigned within the specified organization.
         * </p>
         *
         ...
         *
         * <p>
         * This system authenticates users by both username and
         ...
         *
         * <p>
         * Use {@link #loadUserByUsernameAndOrg(String, String)} instead.
         * </p>
         *
