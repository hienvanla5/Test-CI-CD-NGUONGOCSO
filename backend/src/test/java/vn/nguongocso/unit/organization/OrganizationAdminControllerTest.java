...
import vn.nguongocso.organization.controller.OrganizationController;
...
public class OrganizationAdminControllerTest {
    ...
    void updateOrganizationById_shouldReturnOk_whenAdmin() throws Exception {
        ...
        when(organizationService.updateOrganizationById(eq(targetId), any(OrganizationUpdateRequest.class)))
                .thenReturn(response);
